...
export default function SongTitle({ text, artist, prevImage, setPrevImage, startSong }: titleProps) {
    return (
        <div className="song-title 2xl:ml-7 xl:mt-15 xl:ml-6 lg:mt-2 lg:ml-6 md:mt-1 md:mb-6 md:ml-6 sm:mb-6 sm:ml-6">
            ...
            <div className="play 2xl:mt-6 xl:mt-6 xl:ml-0 lg:ml-2 lg:mt-6 md:ml-5 md:mt-5 sm:mt-5 sm:ml-4">
                <PlayControls prevImage={[prevImage]} startSong={startSong} />
            </div>
