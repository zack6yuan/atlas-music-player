...
export default function PlayListItem() {
    ...
    // set the title when the song is clicked
    const setClickedTitle = () => {
        
    }

    // set the artist when the song is clicked
    const setClickedArtist = () => {

    }

    // compress to single event handler
    const setSong = () => {
        setClickedTitle();
        setClickedArtist();
    }
  ...
  return (
    <div className="">
      ...
      <div className="md:-mt-8">
        <div className="flex sm:-mt-4 sm:ml-19 cursor-pointer" onClick={ setClickedTitle }>
        ...
        <div className="flex rounded sm:mt-1 sm:mr-9 sm:ml-5 cursor-pointer">
        ...
        <div className="flex rounded sm:mt-1 sm:mb-5 sm:mr-9 sm:ml-5 cursor-pointer">
          <div className="font-medium">
